...
class HexPlayerABC
{
    ...
    public:
        ...
        virtual void make_move(HexBoardABC*, HexBoardABC*, bool&)=0;
};
...
class HexPlayerAI:public HexPlayerABC
{
    ...
    public:
        ...
        void make_move(HexBoardABC*, HexBoardABC*, bool&);
};
...
class HexPlayerHuman:public HexPlayerABC
{
    ...
    public:
        ...
        void query_player_move(u_int&, u_int&, std::string, HexBoardABC*&);
        void make_move(HexBoardABC*, HexBoardABC*, bool&);
