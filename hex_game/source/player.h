...
class HexPlayerABC
{
    protected:
        ...
        {
            {BoardType::Real, {3, [](void*& pntr_to_cast, va_list args)-> void {static_cast<HexBoardReal*>(pntr_to_cast)->update(args);}}},
            {BoardType::Virtual, {3, [](void*& pntr_to_cast, va_list args)-> void {static_cast<HexBoardVirtual*>(pntr_to_cast)->update(args);}}},
        };
