...
class HexBoardABC
{
    ...
    public:
        ...
        HexBoardABC(HexBoardABC* root_board):size(root_board->size), game_board(root_board->game_board), player_targets(root_board->player_targets){}
        virtual ~HexBoardABC(){}
...
class HexBoardVirtual:public HexBoardABC
{
    ...
    public:
        ...
        void montecarlo_sim(std::vector<std::pair<u_int, u_int>>, std::vector<std::vector<u_int>>&, VIRTUAL_PIECE, u_int);
};
